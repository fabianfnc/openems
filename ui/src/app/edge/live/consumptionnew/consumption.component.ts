...
@Component({
  selector: ConsumptionComponentNew.SELECTOR,
  templateUrl: './consumption.component.html'
})
export class ConsumptionComponentNew {

  private static readonly SELECTOR = "consumption_new";
  ...
  ngOnInit() {
    this.service.setCurrentComponent('', this.route).then(edge => {
      ...
      this.edge.subscribeChannels(this.websocket, ConsumptionComponentNew.SELECTOR, channels);
    });
  }
  ...
  ngOnDestroy() {
    if (this.edge != null) {
      this.edge.unsubscribeChannels(this.websocket, ConsumptionComponentNew.SELECTOR);
    }
  }
}

...
@Component({
  selector: PickScheduleScheduleDateComponent.SELECTOR,
  templateUrl: './pickscheduledate.component.html'
})
export class PickScheduleScheduleDateComponent {
 ...
 */
  ...
  public onDateRangeChanged(event: IMyDateRangeModel) {
    ...
    this.popoverController.dismiss(datePeriod),
